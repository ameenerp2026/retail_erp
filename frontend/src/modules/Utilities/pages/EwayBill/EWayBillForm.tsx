import type { EWayBillFormField, EWayBillFormState } from './EWayBillGeneration.types'
...
interface EWayBillFormProps {
  data: EWayBillFormData
  form: EWayBillFormState
  today: string
  error: string | null
  onChange: (field: EWayBillFormField, value: string) => void
  onSubmit: () => void
}

export default function EWayBillForm({ data, form, today, error, onChange, onSubmit }: EWayBillFormProps) {
  return (
    <>
