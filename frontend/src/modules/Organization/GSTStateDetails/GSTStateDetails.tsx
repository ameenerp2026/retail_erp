    ...
    <div className="page-shell">
      <div className="page-header">
        ...
        <div className="page-actions">
          <button
            type="button"
            className="flex items-center gap-2 rounded-full border border-gray-300 bg-[#F5F7FB] px-3 py-
2.5 text-sm font-medium text-[#6B7280] sm:px-4"
          >
            <Download size={16} /><span className="hidden sm:inline">Export</span>
          </button>
          <button
            type="button"
            className="flex items-center gap-2 rounded-full bg-[linear-gradient(#093055,#043793)] px-3 p
y-2.5 text-sm font-medium text-white sm:px-4"
          >
      ...
      {/* Search bar */}
      <div className="flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-4 py-2 mb-4
 max-w-md">
